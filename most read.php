...
$id=$_GET['id'];
$idcate=$_GET['category_id'];
$query_post="SELECT * From posts p
left join categories c on p.category_id=c.id
left join `authors` a on p.author_id=a.id
where p.id = ".$id."";
$result_post=$conn->query($query_post);
$post=$result_post->fetch_assoc();
$query_mr="SELECT * From posts p
left join categories c on p.category_id=c.id
left join `authors` a on p.author_id=a.id
where p.category_id = ".$idcate." group by p.created_at desc limit 5";
			...
			<div id="post-header" class="page-header">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10">
							<div class="post-meta">
								<a class="post-category cat-2" href="category.php?category_id=<?=$post['category_id'] ?>"><?= $post['title_category']?></a>
					...
					<div class="col-md-8">
						<div class="section-row sticky-container">
							<div class="main-post">
								...
								<p><b><em><?= $post['description']?></em></b></p>
								<p><?= $post['content'] ?></p>
