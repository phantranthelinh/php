				...
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									<a class="post-img" href="blog-post.html"><img src="<?php echo $posts[0]['thumbnail']; ?>" alt=""></a>
									<div class="post-body">
										<div class="post-meta">
											<a class="post-category cat-3" href="category.html">Jquery</a>
											<span class="post-date"><?php echo $posts[0]['created_at']; ?></span>
										</div>
										<h3 class="post-title"><a href="blog-post.html"><?php echo $posts[0]['title'];  ?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
